...
export async function POST() {
  try {
    ...
    const mockWarranties = [
      { user_id: userId, name: 'Notebook Dell Inspiron 15 3000', category: 'Informática', purchase_date: baseDate(120), warranty_months: 24, store: 'Magazine Luiza', price: 3499.9, estimated_sale_value: 2899.0, notes: 'Compra Black Friday. Inclui mouse e mochila.', serial_number: 'DL123456789BR', total_saved: 0, invoice_url: null, folder: 'Pessoal', maintenance_frequency_months: 6, last_maintenance_date: baseDate(30) },
      { user_id: userId, name: 'iPhone 14 Pro 128GB', category: 'Celulares', purchase_date: baseDate(200), warranty_months: 12, store: 'Apple Store', price: 7499, estimated_sale_value: 6499.0, notes: 'Apple Care+ até dez/2025.', serial_number: 'DNQP12ABC34', total_saved: 150, invoice_url: null, folder: 'Pessoal', maintenance_frequency_months: 12, last_maintenance_date: baseDate(90) },
      { user_id: userId, name: 'Geladeira Brastemp Frost Free', category: 'Eletrodomésticos', purchase_date: baseDate(400), warranty_months: 36, store: 'Casas Bahia', price: 2899, estimated_sale_value: 2199.0, notes: 'Instalação incluída. Porta reversível.', serial_number: 'BRF2023123456', total_saved: 0, invoice_url: null, folder: 'Casa', maintenance_frequency_months: 12, last_maintenance_date: baseDate(180) },
      { user_id: userId, name: 'Smart TV Samsung 55" QLED', category: 'TV e Vídeo', purchase_date: baseDate(60), warranty_months: 12, store: 'Americanas', price: 4299, estimated_sale_value: 3899.0, notes: 'Garantia estendida 2 anos na loja.', serial_number: 'SN55Q70T2024', total_saved: 0, invoice_url: null, folder: 'Pessoal', maintenance_frequency_months: 6, last_maintenance_date: baseDate(20) },
      { user_id: userId, name: 'Furadeira Bosch GSB 21-2 RCT', category: 'Ferramentas', purchase_date: baseDate(30), warranty_months: 24, store: 'Leroy Merlin', price: 599.9, estimated_sale_value: 549.9, notes: 'Kit com maleta e acessórios.', serial_number: 'BOS2024XYZ789', total_saved: 0, invoice_url: null, folder: 'Oficina', maintenance_frequency_months: 24, last_maintenance_date: null },
    ];
