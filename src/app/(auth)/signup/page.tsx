      ...
      <div className="w-full max-w-md space-y-12">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-black tracking-tighter text-slate-900">Comece agora<span className="text-emerald-600">.</span></h1>
            <p className="text-slate-500 font-medium text-sm">Cadastre-se para nunca mais esquecer uma garantia.</p>
          </div>
        </div>
